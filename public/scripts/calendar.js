  ...
  function AddSidebar(){
    ...
    for(var i = 0; i < months.length - 3; i++){
      ...
      if(i==0){
        ...
        x.innerHTML += '<svg height="15" width="15" viewBox="0 0 100 75" fill="rgba(0,0,0,0.9)"><polyline points="0,75 100,75 50,0"></polyline></svg>';
      }
        ...
        x.addEventListener('click', function(){
          typeof calendar.Options.ModelChange == 'function'?calendar.Model = calendar.Options.ModelChange():calendar.Model = calendar.Options.ModelChange;
          createCalendar(calendar, element, 1);} );
        x.innerHTML += '<svg height="15" width="15" viewBox="0 0 100 75" fill="rgba(0,0,0,0.9)"><polyline points="0,0 100,0 50,75"></polyline></svg>';
      }
      else{
  ...
  function AddDateTime(){
      ...
      if(calendar.Options.NavShow && !calendar.Options.NavVertical){
        ...
        rwd.addEventListener('click', function(){
          ...
          if(currentMonth <= calendar.Selected.Month){
    ...
    for(var i = 0; i < calendar.Selected.Days; i++){
      ...
      for(var n = 0; n < calendar.Model.length; n++){
        ...
        if(evDate.toDateString() === toDate.toDateString()){
          ...
          if(calendar.Model[n].type === "graduacion"){
              number.className += " graduacion";
          }
          if(calendar.Model[n].type === "evento"){
              number.className += " evento";
          }
          if(calendar.Model[n].type === "inscripcion"){
              number.className += " inscripcion";
          }
